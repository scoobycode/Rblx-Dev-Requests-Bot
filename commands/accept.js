...
if(!member) return;
if (member.roles.exists(`id`, "400523390441619457") //mod
 || member.roles.exists(`id`, "400512010590355458") //admin
 || member.roles.exists(`id`, "415914501909774336") //head admin
 || member.roles.exists(`id`, "400511826745360405") //comanager
 || member.roles.exists(`id`, "400511217061330955")) { //owner 
let userid = args[0]
